...
public class ZipFunctionElement extends ListFunctionElement {
	 ...
	 */
	@Override
	public Element getValue(List<? extends Element> args) throws CoreASMError {
		...
		if (checkArguments(args)) {
			...
			if (list0.size() != list1.size())
				throw new CoreASMError("Size of lists in zip is not equals.");
			result = new ListElement(zip(list0, list1));
		}
		return result;
	}
