...
public class StateMachine {
	...
	public StateMachine(CompilerEngine engine){
		this.engine = engine;
		states = new ArrayList<org.coreasm.compiler.components.mainprogram.statemachine.EngineState>();
		transitions = new HashMap<String, HashMap<String, ArrayList<org.coreasm.compiler.components.mainprogram.statemachine.EngineTransition>>>();
		onEnter = new HashMap<String, ArrayList<org.coreasm.compiler.components.mainprogram.statemachine.EngineTransition>>();
