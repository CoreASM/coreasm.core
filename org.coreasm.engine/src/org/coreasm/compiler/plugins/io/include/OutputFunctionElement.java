...
public class OutputFunctionElement extends FunctionElement {
	private static final Location OUTPUT_FUNC_LOC = new Location("output", new ArrayList<Element>());

	private Set<Location> locations;
	private StringElement outputValues;
	
	public OutputFunctionElement() {
		//this.setFClass(FunctionElement.FunctionClass.fcOut);
		outputValues = new StringElement("");
		locations = new HashSet<Location>();
		locations.add(OUTPUT_FUNC_LOC);
	}
