...
public class ZipWithFunctionElement extends ListFunctionElement {
	...
	public Element getValue(List<? extends Element> args) {
		if (!checkArguments(args))
			throw new EngineError("Illegal arguments for zipwith.");
		...
		if (f.getSignature() != null && f.getSignature().getDomain().size() != 2)
			throw new EngineError("The function provided to zipwith must have an arity of 2.");
